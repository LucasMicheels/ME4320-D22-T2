...
% Main script
purerawData = frame.manualLoadData('A2M8_Team2_perpendicular_close_cinder_rope_block.xlsx');
figure(1)
frame.elevatorPlotter(purerawData, "pure Raw Data");
purerawData = frame.manualLoadData('A2M8_Team2_perpendicular_far_cinder.xlsx');
figure(2)
frame.elevatorPlotter(purerawData, "pure Raw Data");
